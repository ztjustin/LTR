<?php
   ...
   $table =  $ram->getRamById($conexion,$idRam);

   $rowRam = mysqli_fetch_array($table);
...
<head>
	...
	<title>LTR -  Edit Memory RAM</title>
			...
			<div class="row">
			  <div class="col-sm-12">
					<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					  <a class="navbar-brand" href="#" th:href="@{/admin/index}">LTR APP</a>
		        ...
		        <div class="modal-dialog" role="document">
		            <div class="modal-content">
		                ...
		                <div class="modal-body">
		                    <div class="fetched-data">Memory RAM have been updated successfully!</div> 
		                </div>
				...
				<div class="row">
				  <div class="col-sm-12">
					<div class="card text-center">
					  ...
					  <div class="card-body">
					    <h5 class="card-title"><span>Edit Memory RAM</span></h5>
					...
					<div class="card">
					  ...
					  <div class="card-body">
					    <h5 class="card-title"></h5>
		    				...
		    				<form class="needs-validation" id="formEditRam" novalidate>
								  ...
								  <div class="form-row">
								    ...
								    <div class="col-md-6 mb-3">
								      <div class="input-group">
								        <div class="input-group-prepend">
								          <span class="input-group-text" id="inputGroupPrepend">ID Memory RAM</span>
								        </div>
								        <input type="text" class="form-control"  id="idRam" name="idRam"
								        aria-describedby="inputGroupPrepend" value="<?php  echo "$rowRam[0]";  ?>" required readonly>
								        <div class="invalid-feedback">
								          Please write a valid Memory Ram.
								        </div>
								      </div>
								    </div>  
								  ...
								  <div class="form-row">
								    ...
								    <div class="col-md-6 mb-3">
								      <div class="input-group">
								        <div class="input-group-prepend">
								          <span class="input-group-text" id="inputGroupPrepend">Type Memory RAM</span>
								        </div>
								        <input type="text" class="form-control"  id="type" name="type"
								        aria-describedby="inputGroupPrepend" value="<?php  echo "$rowRam[1]";  ?>" readonly>
								        <div class="invalid-feedback">
								          Please write a valid Type for memory RAM.
								        </div>
								      </div>
								    </div>
								    ...
								    <div class="col-md-6 mb-3">
								      <div class="input-group">
								        <div class="input-group-prepend">
								          <span class="input-group-text" id="inputGroupPrepend">Frecuency</span>
								        </div>
								        <input type="text" class="form-control"  id="frecuency" name="frecuency"
								        aria-describedby="inputGroupPrepend" value="<?php  echo "$rowRam[2]";  ?>" required>
								        <div class="invalid-feedback">
								  ...
								  <div class="form-row">
								    ...
								    <div class="col-md-12 mb-3">
								      <div class="input-group">
								        ...
								        aria-describedby="inputGroupPrepend" value="<?php  echo "$rowRam[3]";  ?>" required>
								        <div class="invalid-feedback">
								    ...
								    <div class="col-md-12 mb-3">
								      <div class="input-group">
								        ...
								        aria-describedby="inputGroupPrepend" value="<?php  echo "$rowRam[4]";  ?>" required>
								        <div class="invalid-feedback">
