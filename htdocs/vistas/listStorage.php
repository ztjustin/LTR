		...
		<!-- End of Row 1  -->
				...
				<div class="row">
				  <div class="col-sm-12">
					<div class="card text-center">
					  ...
					  <div class="card-body">
					    <h5 class="card-title"><span>List of Storages</span></h5>
			...
			<div class="col-sm-12">
				...
				<div class="panel panel-default">
					...
					<table class="table" id="listStorage">
						<thead>
							<tr>
								<th>Serial Storage</th>
								<th>Type</th>
								<th>Model</th>
								<th>Platform Name</th>
								<th>Action</th>
						...
						<tbody>
							<?php include("../php/getStorage.php"); ?>
						</tbody>
					</table>
				</div>
				...
				<a href="../" class="btn btn-info" role="button">Add new Storage</a>
