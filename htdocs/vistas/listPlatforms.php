		...
		<!-- End of Row 1  -->
				...
				<div class="row">
				  <div class="col-sm-12">
					<div class="card text-center">
					  ...
					  <div class="card-body">
					    <h5 class="card-title"><span>List of Platforms</span></h5>
			...
			<div class="col-sm-12">
				...
				<div class="panel panel-default">
					...
					<table class="table" id="listPlatforms">
						<thead>
							<tr>
								<th>Serial Platform</th>
								<th>Name</th>
								<th>Check In Date</th>
								<th>Ubication</th>
								<th>Active Number</th>
						...
						<tbody>
							<?php include("../php/getPlatforms.php"); ?>
						</tbody>
					</table>
				</div>
				...
				<a href="../" class="btn btn-info" role="button">Add new Platform</a>
