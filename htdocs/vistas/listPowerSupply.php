		...
		<!-- End of Row 1  -->
				...
				<div class="row">
				  <div class="col-sm-12">
					<div class="card text-center">
					  ...
					  <div class="card-body">
					    <h5 class="card-title"><span>List of Power Supply</span></h5>
			...
			<div class="col-sm-12">
				...
				<div class="panel panel-default">
					...
					<table class="table" id="listSupply">
						<thead>
							<tr>
								<th>Serie Power Supply</th>
								<th>Model</th>
								<th>Platform Name</th>
								<th>Action</th>
							</tr>
						...
						<tbody>
							<?php include("../php/getPowerSupply.php"); ?>
						</tbody>
					</table>
				</div>
				...
				<a href="#" class="btn btn-info" role="button">Add new Power Supply</a>
